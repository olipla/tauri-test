...
<template>
  <UCard class="w-64 h-28 shrink-0 bg-elevated" :class="{ 'cursor-pointer': props.showSettings && props.title !== undefined, 'hover:bg-elevated/50': props.showSettings && props.title !== undefined }" :ui="{ root: 'flex flex-col', body: ` grow p-2 sm:p-2 !pt-1 h-16 flex ${title === undefined ? 'min-h-full' : ''}`, header: 'p-2 sm:p-2' }">
